            ...
            https.get(`https://euw1.api.riotgames.com/lol/summoner/v3/summoners/by-name/${sname}?api_key=RGAPI-1bdbc014-4437-4746-a22d-d3dd31daef7d`, (resp) => {
                ...
                resp.on('end', () => {
                    ...
                    if (base1.status != null) {
                        ...
                        let msg = `${base.name} is a level ${base.summonerLevel} and ${base1[1].tier} ${base1[1].rank}(${base1[1].leaguePoints}LP) boosted guy, report him and make your life much more easier!`;
                        msg.react('♥');
                        msg.reply(msg);
                        }
                    });
